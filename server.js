...
//   });
  ...
  await ActorController.addMovie(actor1.id, movie1.id);
// >> added Movie id=1 to Actor id=1

await ActorController.addMovie(actor1.id, movie2.id);
// >> added Movie id=2 to Actor id=1

await ActorController.addMovie(actor1.id, movie3.id);
// >> added Movie id=3 to Actor id=1

await ActorController.addMovie(actor2.id, movie3.id);
// >> added Movie id=3 to Actor id=2

await ActorController.addMovie(actor2.id, movie4.id);
// >> added Movie id=4 to Actor id=2

await ActorController.addMovie(actor2.id, movie1.id);
